...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 1.0f, 1.0f, 0.7f);
        ...
        // Segunda fuente de luz, con otro par de teclas y que afecte el modelo.
